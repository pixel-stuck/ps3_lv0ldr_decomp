...
s32 obj_488::func_580(u64 arg1, const char* arg2, u64* arg3, u64* arg4) {
...
s32 obj_488::func_678(u64 arg1, u64* arg2) {
    u64 sp20;
    u64 sp30;
    u64 res;
...
s32 obj_488::func_808(u64 arg1, u64* arg2) {
    // TODO: is there a better way than arg0 array?
    u64 sp20[12];
...
s32 obj_488::func_a18(u64 arg1, u64* arg2) {
    u64 sp20[12];
    u64 temp1;
    u64 temp2;
    s32 result;
...
s32 obj_488::func_c68(u64 arg2, u64* arg3) {
    if(func_f2a8(this) > 0) {
...
// s32 __attribute__((naked)) obj_488::func_cf0(u64* arg1) {
//     INCLUDE_ASM("asm/nonmatching", func_cf0);
// }

s32 obj_488::func_cf0(u64* arg1) {
    u64 flash_addr;
    u8 temp;
    s32 (obj_488::*funcptr1)(u64, u64*);
    s32 (obj_488::*funcptr2)(u64, u64*);
    ...
    if(temp != 0) {
        funcptr2 = &obj_488::func_c68;
        funcptr1 = &obj_488::func_f28;
    } else {
        funcptr2 = &obj_488::func_f28;
        funcptr1 = &obj_488::func_c68;
    }
...
void obj_488::func_e38(s32 arg1, s32 arg2) {
    func_f590(this, arg1, arg2);
}

s32 obj_488::func_e40() {
    s32 res;
    u64 temp;
...
s32 obj_488::func_f28(u64 arg1, u64* arg2) {
    if(func_f2a8(this) <= 0) {
...
void obj_488::func_fa0(s32 arg0, s32 arg1) {
    if(arg0 == 1) {
        if(arg1 == 0xFFFF) {
...
void obj_488::func_fd8(void) {
    func_fa0(0, 0xFFFF);
}

void obj_488::func_fe8(void) {
    func_fa0(1, 0xFFFF);
}

s32 obj_488::func_ff8() {
    s32 sp20;
    if(func_1740(&sp20) == 0) {
        return 0;
    } else {
...
void __attribute__((naked)) obj_488::func_10b0() {
    INCLUDE_ASM("asm/nonmatching", func_10b0);
}

void __attribute__((naked)) obj_488::func_1120() {
...
s32 __attribute__((naked)) obj_488::func_1188(u64 arg1) {
