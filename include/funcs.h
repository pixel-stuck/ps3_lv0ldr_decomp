...
void func_10b0(obj1*);
void func_1120(obj1*);
int func_1188(obj1*, long long);
int func_1740(int*);
int func_1ab0(long long, struct_func_1ab0*);
int func_18e0(long long, int, const char*, long long*);

void func_1e00(unk_struct_2f9b0*, long long);
void func_26b8(unk_struct_2f9b0*);
void func_2818(unk_struct_2f9b0*);

//ctor
void func_4618(unk_struct_1188_3*, void*, int);
